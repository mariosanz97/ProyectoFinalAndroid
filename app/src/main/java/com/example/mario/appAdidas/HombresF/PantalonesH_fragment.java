...
public class PantalonesH_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_pantalones_hombres, container, false);
        ...
        myref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot child : dataSnapshot.child("pantalones").getChildren()) {
                    ...
                    System.out.println("-----sasaModelo-----> " + child.getValue(Ropa.class).getModelo() + "----PRECIO--->" + child.getValue(Ropa.class).getPrecio() + "----DES--->" + child.getValue(Ropa.class).getDescripcion());

                    if (child.getValue(Ropa.class).getPara().equals("Hombre")) {
