...
public class MujeresActivity extends AppCompatActivity implements PantalonesH_fragment.OnFragmentInteractionListener, SudaderasH_fragment.OnFragmentInteractionListener, ZapatillasH_fragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
...

        {
            ...
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                if (menuItems.get(arg2).toString().equals("Mi Perfil")) {
                    Intent intent = new Intent(MujeresActivity.this, PerfilActivity.class);
                    startActivity(intent);
                    //finish();

                } else if (menuItems.get(arg2).toString().equals("Hombres")) {
                    Intent intent = new Intent(MujeresActivity.this, HombresActivity.class);
                    startActivity(intent);
                    //finish();
                } else if (menuItems.get(arg2).toString().equals("Home")) {
                    Intent intent = new Intent(MujeresActivity.this, HomeActivity.class);
                    startActivity(intent);
                    //finish();
                }  else if (menuItems.get(arg2).toString().equals("Niños")) {
                    Intent intent = new Intent(MujeresActivity.this, NinosActivity.class);
                    startActivity(intent);
                    //finish();
                } else if (menuItems.get(arg2).toString().equals("Encuentranos")) {
                    Intent intent = new Intent(MujeresActivity.this, Localizacion.class);
                    startActivity(intent);
                    //finish();
                }else if (menuItems.get(arg2).toString().equals("Contactanos")) {
                    Intent intent = new Intent(MujeresActivity.this, contactActivity.class);
                    startActivity(intent);
                    //finish();
                }else if (menuItems.get(arg2).toString().equals("Log out")) {
                    finish();
                    startActivity(new Intent(MujeresActivity.this, LoginActivity.class));
                }
        ...
        PantalonesM_fragment fragmento1 = new PantalonesM_fragment();
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.Pantalones) {
                    ...
                    SudaderasM_fragment fragmento2 = new SudaderasM_fragment();
                    ...
                    ZapatillasM_fragment fragmento3 = new ZapatillasM_fragment();
                    FragmentTransaction transition1 = getSupportFragmentManager().beginTransaction();
